...
set _DeploySetParametersFile=%RootPath%MaintenanceManagementSystem.API.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%MaintenanceManagementSystem.API.zip" (
echo "%RootPath%MaintenanceManagementSystem.API.zip" does not exist. 
...
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%MaintenanceManagementSystem.API.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension
) else (
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%MaintenanceManagementSystem.API.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -setParamFile:"%_DeploySetParametersFile%"
)
...
:usage
echo =========================================================
if not exist "%RootPath%MaintenanceManagementSystem.API.deploy-readme.txt" (
...
start notepad "%RootPath%MaintenanceManagementSystem.API.deploy-readme.txt"
)
echo =========================================================
goto :eof
